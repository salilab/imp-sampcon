...
python /home/rakesh/WORK/Projects/3-SPOTSComplex/IMPModeling/AnalysisModules/imp-sampcon/pyext/src/Master_Sampling_Exhaustiveness_Analysis.py --sysname $name --path $analys_dir --ambiguity --mode cuda --cores 4 --align --density density.txt --gridsize 5.0 --gnuplot --scoreA A_models_clust-1.txt --scoreB B_models_clust-1.txt --rmfA A_models_clust-1.rmf3 --rmfB B_models_clust-1.rmf3
