...
stats sprintf("%s.CT.txt", ARG1) usi 1 prefix "R"
stats sprintf("%s.PV.txt", ARG1) usi 1 prefix "B"
...
set output sprintf("%s.PC.pdf" , ARG1)
plot sprintf("%s.CT.txt", ARG1) usi 1:2 w p pt 7 ps 2.5 lc rgb "#FF4500" title "{/Symbol c}^2-test p-value", \
